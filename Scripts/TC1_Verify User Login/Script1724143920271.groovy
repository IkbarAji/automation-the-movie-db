...
WebUI.click(findTestObject('Object Repository/Home_Page/menu_login'))
...
WebUI.verifyElementPresent(findTestObject('Object Repository/Profile_Page/title_stats'), 10)
